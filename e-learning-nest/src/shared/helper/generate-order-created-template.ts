...
<head>
    ...
    <title>Đơn hàng đã được khởi tạo thành công - Chờ thanh toán</title>
    <style>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; border: 1px solid #e2e8f0; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05);">
                    ...
                    <tr>
                        <td bgcolor="#4f46e5" align="center" style="padding: 32px 20px; color: #ffffff;">
                            ...
                            <p style="margin: 8px 0 0 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 500; color: #e0e7ff;">Đơn Hàng Đã Được Khởi Tạo Thành Công</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 32px 24px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 15px; line-height: 24px; color: #475569;">
                                Cảm ơn bạn đã lựa chọn đăng ký học tập tại <strong>${companyName}</strong>! Đơn hàng của bạn đã được khởi tạo thành công trên hệ thống và đang chờ bạn hoàn tất thủ tục thanh toán.
                            </p>
                            ...
                            <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin-bottom: 24px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 14px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
                                    ...
                                    <tr>
                                        <td style="padding: 4px 0; color: #64748b;"><strong>Ngày tạo:</strong></td>
                                        <td style="padding: 4px 0; text-align: right; color: #0f172a;">${orderDate}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 4px 0; color: #64748b;"><strong>Trạng thái đơn hàng:</strong></td>
                                        <td style="padding: 4px 0; text-align: right; color: #f59e0b; font-weight: bold;">CHỜ THANH TOÁN</td>
                                    </tr>
                                </table>
                            </div>
                            
                            <!-- Bảng khóa học -->
                            <h3 style="margin: 0 0 12px 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 15px; color: #0f172a; border-bottom: 2px solid #e2e8f0; padding-bottom: 6px;">Danh mục học liệu đăng ký</h3>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 32px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px;">
                                ...
                                <tr>
                                    <td style="padding: 12px 0 4px 0; font-size: 16px; color: #0f172a; font-weight: bold; text-align: right; border-top: 1px solid #e2e8f0;">Tổng tiền cần thanh toán:</td>
                            ...
                            <p style="margin: 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; color: #64748b; text-align: center;">
                                Bạn vui lòng nhấn vào nút <strong>Thanh toán ngay</strong> ở trên để xem mã QR chuyển khoản và hoàn tất đơn hàng. Sau khi nhận được tiền, hệ thống sẽ kích hoạt khóa học tự động sau ít giây!
                            </p>
                        </td>
                    </tr>
