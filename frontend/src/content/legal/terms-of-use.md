...
- Bạn chịu trách nhiệm giữ bí mật mật khẩu và mọi hoạt động dưới tài khoản của mình. Thông báo ngay cho chúng tôi nếu phát hiện truy cập trái phép (chúng tôi có gửi email cảnh báo khi có đăng nhập mới).
...
## 4. Giảng viên
- Giảng viên tự chịu trách nhiệm về nội dung mình đăng và bảo đảm có đầy đủ quyền sử dụng nội dung đó.
- Giảng viên cấp cho Dịch vụ quyền lưu trữ, hiển thị và phân phối nội dung để cung cấp khoá học.
- Khoá học có thể bị từ chối, gỡ hoặc yêu cầu chỉnh sửa nếu vi phạm điều khoản hoặc pháp luật.
- Giảng viên có thể gửi thông báo tới học viên của khoá mình; các thông báo này phải được quản trị viên duyệt trước khi gửi qua email.

## 5. Đơn hàng và thanh toán
- Giá hiển thị bằng Việt Nam đồng (VND). Thanh toán bằng chuyển khoản ngân hàng theo thông tin và nội dung chuyển khoản do hệ thống tạo cho từng đơn.
...
## 7. Đánh giá, bình luận và kiểm duyệt
Bạn chịu trách nhiệm về nội dung bạn đăng (đánh giá, bình luận, câu hỏi, tài liệu cộng đồng). Người dùng có thể báo cáo nội dung vi phạm; quản trị viên có quyền ẩn, xoá nội dung hoặc hạn chế tài khoản vi phạm mà không cần báo trước.

## 8. Thư điện tử
Chúng tôi gửi thư giao dịch (OTP, xác nhận đơn hàng, cảnh báo đăng nhập) — không thể tắt — và thư thông báo, có thể ngừng nhận bất cứ lúc nào theo [Chính sách bảo mật](/privacy).

## 9. Tạm ngừng và chấm dứt
Chúng tôi có thể tạm khoá hoặc chấm dứt tài khoản vi phạm điều khoản. Bạn có thể yêu cầu xoá tài khoản theo hướng dẫn trong Chính sách bảo mật. Việc chấm dứt không ảnh hưởng đến các nghĩa vụ đã phát sinh trước đó.

## 10. Bảo trì và gián đoạn
